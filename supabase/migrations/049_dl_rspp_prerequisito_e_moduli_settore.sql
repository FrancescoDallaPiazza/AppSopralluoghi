-- =====================================================================
-- 049 - DL-RSPP: prerequisito corretto + moduli di settore ATECO.
--
...
update corso_catalogo
   set attivo = false,
       note   = 'DEPRECATO dalla 049. Le 16h base del DL-RSPP coincidono col corso DATORE_LAVORO (art. 37) e sono il PREREQUISITO, non un modulo proprio. Conservato solo per compatibilita con attestati storici.'
